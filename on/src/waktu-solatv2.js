...
(function() {
    ...
    // JAKIM Zone Mapping - Complete and accurate
    const JAKIM_ZONES = {
        'johor': [
    ...
    const mosqueBtn = document.getElementById('ws-mosque-btn');
    const pdfBtn = document.getElementById('ws-pdf-btn');
    const shareBtn = document.getElementById('ws-share-btn');
    const monthlySection = document.getElementById('ws-monthly-section');
    ...
    function setupEventListeners() {
        ...
        mosqueBtn.addEventListener('click', findNearbyMosques);
    ...
    async function loadPrayerTimesAladhan() {
        try {
            ...
            const coords = getZoneCoordinates(currentZoneCode);
            ...
            if (data.code === 200 && data.data) {
                ...
                throw new Error('Gagal memuat data alternatif');
            }
    ...
    function getZoneCoordinates(code) {
        const coords = {
            'SGR01': {lat: 3.2190, lng: 101.7258},
            'SGR02': {lat: 3.3375, lng: 101.2525},
            'SGR03': {lat: 3.0333, lng: 101.5000},
            'WLY01': {lat: 3.1390, lng: 101.6869},
            'WLY02': {lat: 2.9264, lng: 101.6964},
            'JHR01': {lat: 2.0000, lng: 104.0000},
            'JHR02': {lat: 1.4655, lng: 103.7578}
        };
        
        return coords[code] || {lat: 3.1390, lng: 101.6869};
    }
    ...
    function findNearbyMosques() {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            const url = `https://www.google.com/maps/search/masjid+mosque/@${lat},${lng},15z`;
